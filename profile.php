...
<div class="information">
    ...
    <div>
        ...
        <input name="fbirthday" value="<?php echo $birthday?>" class="input-item" >
    ...
    <div>
        ...
        <input name="fgender" value="<?php echo $gender?>" class="input-item" >
    ...
    <div>
        ...
        <input name="fphone" value="<?php echo $phone?>" class="input-item" >
    ...
    <div>
        ...
        <input name="fcity"  value="<?php echo $city?>" class="input-item" >
