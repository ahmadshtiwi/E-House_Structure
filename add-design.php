...
if(isset($_POST['add']))
{
	...
	if ($error === 0) {
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
				...
				$img_upload_path = 'designs/'.$new_img_name;
		        ...
		        header("Location: add-design.php?error=$em");
			}
    ...
    $price=(int)isset($_POST['fprice'])?$_POST['fprice']:0;
    $area=(int)isset($_POST['farea'])?$_POST['farea']:0;
    $room=(int)isset($_POST['froom'])?$_POST['froom']:0;
    $bathroom=(int)isset($_POST['fbathroom'])?$_POST['fbathroom']:0;
    $balcony =(int)isset($_POST['fbalcony'])?$_POST['fbalcony']:0;
    $garden=(int)isset($_POST['fgarden'])?$_POST['fgarden']:0;
    $city=isset($_POST['fcity'])?$_POST['fcity']:"";
    ...
    else
    {
        ...
        $add_design="INSERT INTO designs(price,area,room,bathroom,balcony,garden,city,image_design,id_person) 
        VALUES($price,$area,$room,$bathroom,$balcony,$garden,'$city','$new_img_name',$id_person)";
    
    
        if(mysqli_query($conn,$add_design))
        {
            $em = "Yes";
...
<head>
    ...
    <link rel="stylesheet" href="styles/add-design.css">
...
<svg class="sv" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="1200px" id="blobSvg" style="opacity: 1;"><defs>                
...
<form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
    ...
    <div class="image_session">
        ...
        <img src="designs/<?php echo $new_img_name?>" id="my-image" class="image-design" >
    ...
    <div class="information">
        ...
        <div>
            ...
            <input type="number" placeholder="2000" name="fprice" >
        ...
        <div>
            ...
            <input type="number" placeholder="20" name="farea">
    ...
    <div class="contener-buttons">
        ...
        <a class="edit-design-btn" href=edit-design.php>Edit</a>
        <button class="buttons" name="add" type="submit" >Add</button>
...
<script src="code/add-design.js"></script>
</body>
</html>